...
class Menu {
  ...
  // Endpoint Get Menu By price in every category
  static async getMenuByPrice(req, res, next) {
    try {
   ...
   // Endpoint Get Menu By Category (Query Params)
  static async getMenuByCategoryQuery(req, res, next) {
    try {
      ...
      const data = await menu.findAll(findOptions);
  ...
  // Endpoint Get Menu By Category (Original Params)
