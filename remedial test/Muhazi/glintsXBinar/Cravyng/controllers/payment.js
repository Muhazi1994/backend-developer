const { payment, order, users } = require("../models");
const { midtransSnap } = require("../util/midtrans");
const moment = require("moment");
const { orderDetail } = require("../middlewares/validators/order-menu");
const { findUserId } = require("./orders");
  ...
  try {
    ...
    if (transactionStatus == "capture") {
      ...
      let transporter = nodemailer.createTransport({
        service: "Gmail",
        auth: {
          users: "shuttlefinalproject@gmail.com",
          pass: "@Secret123",
        },
      });
